...
const BestSellers = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto py-16 px-4" id="bestsellers">
      <h2 className="text-3xl md:text-4xl font text-white mb-10 text-center font-sans tracking-tight" style={{ fontFamily: 'var(--font-primary)' }}>Best Sellers</h2>
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {products.map(product => (
            <div key={product._id} className="bg-zinc-900 rounded-2xl shadow-lg p-4 flex flex-col items-center transition hover:scale-105 hover:shadow-2xl">
